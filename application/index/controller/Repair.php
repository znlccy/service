...
class Repair extends BasisController
{
    /**
     * 显示资源列表
     *
    ...
    public function index()
    {
        ...
        if ($equipment_no) {
            $conditions[] = ['equipment_no', '=', $equipment_no];
        }
    ...
    public function save()
    {
        ...
        // 获取当前用户信息
        $user = session('user');
        $repair_man = request()->param('repair_man', $user['username']);
        $mobile = request()->param('mobile', $user['mobile']);
