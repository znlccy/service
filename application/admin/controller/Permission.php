...
class Permission extends BaseController {
    ...
    public function add() {
        ...
        $result = $this->validate($data,'Permission.add');
...
//                'create_time'   => date('Y-m-d H:i:s', time())
    ...
    public function node_list() {
        ...
        $result = $this->validate($data,'Permission.nodeList');
    ...
    public function delete() {
        ...
        $result = $this->validate($data,'Permission.delete');
    ...
    public function detail() {
        ...
        $result = $this->validate($data,'Permission.detail');
