...
class Admin extends BaseController
{
    ...
    public function mobile_login()
    {
        ...
        $result = $this->validate($validate_data, 'Admin.mobileLogin');
        if (true !== $result) {
    ...
    public function account_login()
    {
        ...
        $result = $this->validate($validate_data, 'Admin.accountLogin');
        if (true !== $result) {
            return json(['code' => 401, 'message' => $result]);
        }
...
//        $operation_team_id = request()->param('operation_team_id', 0);
        ...
        $result = $this->validate($validate_data, 'Admin.adminList');
    ...
    public function detail()
    {
        ...
        $admin_data = AdminModel::where('id', '=', $id)
            ->with(['role' => function ($query) {
                $query->withField("pivot");
            }, 'operationTeam' => function ($query) {
    ...
    public function change_password()
    {
        ...
        $result = $this->validate($validate_data, 'Admin.changePassword');
