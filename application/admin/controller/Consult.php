...
class Consult extends BaseController {
    ...
    public function __construct(App $app = null)
    {
        ...
        $this->consult_validate = new ConsultValidate();
    ...
    public function index() {
        ...
        $page_size = request()->param('page_size/d',$this->consult_page['PAGE_SIZE']);
        $jump_page = request()->param('jump_page/d',$this->consult_page['JUMP_PAGE']);
